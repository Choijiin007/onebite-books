...
//   };
  ...
  export const getStaticPaths = () => {
    return{
        //SSG방식 -> 어떠한 경로가 있을 수 있는지 미리 설정하는 것.
        paths:[
            {params:{id:"1"}},
            {params:{id:"2"}},
            {params:{id:"3"}},
        ],
        // fallback이란? 일종의 보험, 대비책으로 만약 경로에 1,2,3 외 다른 숫자가 나왔을 때를 대비한다.
        //false는 404페이지로 연결된다.
        fallback:true,
        //false: 묻지도 따지지도 않고 404페이지
        //"blocking": SSR방식으로 페이지 생성 후 보여줌
        //true: SSR방식으로 페이지를 보여줌 + 데이터가 없는 폴백 상태의 페이지부터 반환해줌
    }
  }
...
return <div className={style.container}>
    <div className={style.cover_img_container} style={{backgroundImage: `url('${coverImgUrl}')`}} >
        <Image src={coverImgUrl} alt={"커버이미지"}/>
    </div>
